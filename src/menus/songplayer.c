...
void updateSongPlayer() {
  if (songs.count > 0) {
    ...
    // SIMD i found off of stack overflow, basically now I can't compile this
    // for arm, TODO write a normal Clampf function for arm and 32 bit targets
    _mm_store_ss(&status.songProgressPercent,
